            ...
            <div class="col">
                <div class="card summary-kategori">
                    <div class="card-body">
                        ...
                        <p class="card-text text-white fs-4">Kategori</p>
            ...
            <div class="col">
                <div class="card summary-hewandanlayananlainnya">
                    <div class="card-body">
                        ...
                        <p class="card-text text-white fs-4">Jumlah Konten: </p>
            ...
            <div class="col">
                <div class="card summary-hewandanlayananlainnya">
                    <div class="card-body">
                        ...
                        <p class="card-text text-white fs-4">Jumlah Ticket: </p>
            ...
            <div class="col">
                <div class="card summary-hewandanlayananlainnya">
                    <div class="card-body">
                        ...
                        <p class="card-text text-white fs-4">Jumlah Pesanan: </p>
            ...
            <div class="col">
                <div class="card summary-hewandanlayananlainnya">
                    <div class="card-body">
                        ...
                        <p class="card-text text-white fs-4">Jumlah Berita: </p>

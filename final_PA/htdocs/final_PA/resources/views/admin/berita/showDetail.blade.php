...
<body>
    ...
    <div class="container">
            ...
            <div class="row g-0">
                <div class="col-md-4">
                    <a href="/public/berita/{{ $berita->gambar}}" data-toggle="modal" data-target="#imageModal{{ $berita->id }}">
                        <img src="/public/berita/{{ $berita->gambar}}" alt="Bukti Pembayaran" class="img-fluid p-3">
                    </a>
                </div>
                <div class="col-md-8">
                    <div class="card-body">
        ...
        <a href="{{ route('admin.berita.index')}}" class="btn btn-secondary" style="float: right;">Kembali</a>
    </div>

                     ...
                     <div class="col-sm-12 col-md-4 mb-3">
                         <div class="card h-100">
                             ...
                             <div class="card-body">
                                 ...
                                 <a href="service-detail.php?name=<?php echo $data['name']; ?>   " class="btn warna2 text-white"> See Details </a>
                             </div>
                         </div>
                     </div>
                 <?php } ?>
             </div>
             <a class="btn btn-outline-warning mt-3 " href="service.php"> See More</a>
         </div>
     </div>

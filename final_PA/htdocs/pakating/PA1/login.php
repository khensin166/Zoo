        ...
        <div class="card border-0 shadow rounded-3 my-5">
          ...
          <h5 class="card-title text-center mb-5 fw-light fs-5">Khusus Sivitas IT Del</h5><br>
            ...
            <div class="form-floating mb-3">
              ...
              <hr class="my-4">
              <h5 class="card-title text-center mb-5 fw-light fs-5">Belum punya akun ? || <a href="registrasi.php" > Sign Up </a></h5>
              <h6 class="card-title text-center mb-5 fw-light fs-5">Sign Up as Admin? || <a href="loginadmin.php" > Here </a></h6>

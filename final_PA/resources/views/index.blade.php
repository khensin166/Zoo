...
<body>
            ...
            <div class="row mt-5">
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-mamalia d-flex justify-content-center align-items-center">
                        <h4 class="text-white"><a href="{{ route('all.konten.wisatwan')}}" class="no-decoration">Mamalia</a></h4>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-melata d-flex justify-content-center align-items-center">
                        <h4 class="text-white"><a href="{{ route('all.konten.wisatwan')}}" class="no-decoration">Melata</a></h4>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-unggas d-flex justify-content-center align-items-center">
                        <h4 class="text-white"><a href="{{ route('all.konten.wisatwan')}}" class="no-decoration">Unggas</a></h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-1 bg-dark text-light">
        <div class="container d-flex justify-content-between">
            ...
            <label>By: Kelompok 5 PA1 D3TI 22 &copy; IT Del</label>
        </div>
    </div>
